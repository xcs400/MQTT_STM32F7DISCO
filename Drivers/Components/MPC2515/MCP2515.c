...
#define MCP2515_CS_HIGH()   HAL_GPIO_WritePin(ARDUINO_PWM_D10_GPIO_Port, ARDUINO_PWM_D10_Pin, GPIO_PIN_SET)
#define MCP2515_CS_LOW()    HAL_GPIO_WritePin(ARDUINO_PWM_D10_GPIO_Port, ARDUINO_PWM_D10_Pin, GPIO_PIN_RESET)
